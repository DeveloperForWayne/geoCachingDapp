...
let cacheJson = require("../json/Cache.json")
let cacheAbi = cacheJson.abi;
let cacheBytecode = cacheJson.bytecode;
            ...
            <div className="container border">
                ...
                <form onSubmit={this.handleSubmit}>
                    <div className="form-group row">
                        <label className="col-sm-2 col-form-label">Cache Name:</label>
